...
fn.entry:
  ...
  call void ({ i32, i32 }, ...) @emit({ i32, i32 } %access.tuple.access4)
  ...
  call void ({ ptr }, ...) @emit({ ptr } %access.tuple.access7)
  ...
  call void ({ ptr }, ...) @emit({ ptr } %access.tuple.access10)
  ...
  call void ({ i32 }, ...) @emit({ i32 } %access.tuple.access13)
  ...
  call void ({ float }, ...) @emit({ float } %access.tuple.access16)
  ...
  call void ({ { i32 } }, ...) @emit({ { i32 } } %access.tuple.access22)
  ...
  call void ({ { { i32 } } }, ...) @emit({ { { i32 } } } %access.tuple.access31)
  ret void
}
