; ModuleID = 'tests.object'
source_filename = "tests.object"
...
fn.entry:
  ...
  call void ({ i32 }, ...) @emit({ i32 } %access.object)
  ...
  call void ({ i32, i32 }, ...) @emit({ i32, i32 } %access.object4)
  ...
  call void ({ i32, i32, i32 }, ...) @emit({ i32, i32, i32 } %access.object9)
  ret void
}
